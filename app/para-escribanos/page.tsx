...
function BeneficioCard({ beneficio, index }: { beneficio: typeof BENEFICIOS[0]; index: number }) {
  return (
    <motion.div
      variants={scaleIn}
      whileHover={{ y: -4 }}
      className="relative bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group"
    >
      <div className="p-6">
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-xs text-primary-500">{beneficio.statLabel}</p>
          </div>
        </div>
        <h3 className="mt-4 text-lg font-semibold text-primary-900">{beneficio.title}</h3>
        <p className="mt-2 text-sm text-primary-600">{beneficio.description}</p>
      </div>
    </motion.div>
  );
}
...
function FuncionalidadCard({ func }: { func: typeof FUNCIONALIDADES[0] }) {
  return (
    ...
    >
      ...
      <div>
        <h3 className="font-semibold text-primary-900">{func.title}</h3>
        <p className="mt-1 text-sm text-primary-600">{func.description}</p>
      </div>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className={cn("p-6", plan.popular && "pt-12")}>
        {/* Header */}
        <div>
          <h3 className="text-xl font-bold text-primary-900">{plan.nombre}</h3>
          <p className="mt-1 text-sm text-primary-500">{plan.descripcion}</p>
        </div>

        {/* Precio */}
        <div className="mt-6">
          <div className="flex items-baseline gap-1">
            <span className="text-4xl font-bold text-primary-900">{precio}</span>
            {plan.periodo && (
              <span className="text-primary-500">{plan.periodo}</span>
            )}
          </div>
        ...
        <ul className="mt-6 space-y-3">
          ...
          {plan.limitaciones.map((limit, i) => (
            <li key={i} className="flex items-start gap-3 text-sm text-primary-400">
    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-gray-100 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-primary-500">{testimonio.cargo}</p>
        </div>
  ...
  return (
    <motion.div variants={fadeInUp} className="border-b border-gray-200 last:border-0">
      ...
      >
        ...
        <span className="flex-1 font-semibold text-primary-900">{faq.pregunta}</span>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <p className="pb-5 pl-12 text-primary-600 leading-relaxed">
              {faq.respuesta}
            </p>
          </motion.div>
        )}
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p
              variants={fadeInUp}
              className="mt-6 text-lg sm:text-xl text-primary-200 max-w-xl"
            >
            ...
            >
              {STATS.map((stat) => (
                <div key={stat.label} className="text-center sm:text-left">
                  ...
                  <p className="text-xs sm:text-sm text-primary-300">{stat.label}</p>
                </div>
              ))}
            </motion.div>
            ...
            <motion.div
              variants={fadeInUp}
              className="mt-10 flex items-center gap-6 text-sm text-primary-300"
            >
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-6 transform rotate-2">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-semibold text-primary-900">Tu Dashboard</p>
                    <p className="text-xs text-primary-500">Enero 2025</p>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="bg-blue-50 rounded-xl p-3 text-center">
                    ...
                    <p className="text-xs text-blue-700">Conversión</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-primary-900">Nueva reserva</p>
                    <p className="text-xs text-primary-500">Juan P. - Escritura</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-primary-900">Mañana 10:00</p>
                    <p className="text-xs text-primary-500">3 turnos confirmados</p>
                  </div>
                </div>
              </motion.div>
            </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeInUp} className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="mt-4 text-2xl sm:text-3xl lg:text-4xl font-bold font-serif text-primary-900">
  ...
  return (
    <section className="py-20 sm:py-28 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div variants={fadeInUp} className="text-center max-w-2xl mx-auto">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-serif text-primary-900">
...
function ComoFuncionaSection() {
  return (
    <section id="como-funciona" className="py-20 sm:py-28 bg-gray-50 scroll-mt-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          initial="hidden"
          whileInView="visible"
            ...
            {PASOS.map((paso, index) => (
              <motion.div key={paso.numero} variants={fadeInUp} className="relative">
                ...
                <div className="relative z-10 text-center">
                  <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-amber-400 to-amber-600 shadow-lg shadow-amber-500/30 flex items-center justify-center">
                    <paso.icon className="w-7 h-7 text-white" />
                  </div>
                  <span className="inline-block mt-4 px-3 py-1 rounded-full text-xs font-bold bg-primary-100 text-primary-600">
                    Paso {paso.numero}
                  </span>
                  <h3 className="mt-3 text-lg font-semibold text-primary-900">{paso.titulo}</h3>
                  <p className="mt-2 text-sm text-primary-600">{paso.descripcion}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
    ...
    <section className="py-20 sm:py-28 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            variants={staggerContainer}
            className="mt-10 bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden"
          >
            {FAQS.map((faq, i) => (
...
function CTAFinalSection() {
  return (
    <section className="py-20 sm:py-28 bg-gradient-to-br from-primary-950 via-primary-900 to-primary-950 text-white relative overflow-hidden">
      {/* Glows */}
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="mt-6 text-lg text-primary-200 max-w-2xl mx-auto">
          ...
          <motion.div
            variants={fadeInUp}
            className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm text-primary-300"
          >
            <span className="flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-emerald-400" />
